...
int	main()
{
	...
	myList1 = insertAtTail(myList1, 5);
	myList1 = insertAtTail(myList1, 9);
	myList1 = insertAtTail(myList1, 1);
	myList1 = insertAtTail(myList1, 8);
	myList1 = insertAtTail(myList1, 4);
	myList1 = insertAtTail(myList1, 7);
	myList1 = insertAtTail(myList1, 3);
	myList1 = insertAtTail(myList1, 6);
	myList1 = insertAtTail(myList1, 2);

	printf("\nMy List 1 Before SORTING...\n");
	printList(myList1);
	sortList(myList1);		// SORTING a Linked List
	printf("\nMy List 1 After SORTING...\n");
	printList(myList1);

	Node	*myList2 = NULL;

	myList2 = insertAtHead(myList2, 6);
	myList2 = insertAtHead(myList2, 7);
	myList2 = insertAtHead(myList2, 5);
	myList2 = insertAtHead(myList2, 1);
	myList2 = insertAtHead(myList2, 8);
	myList2 = insertAtHead(myList2, 5);
	myList2 = insertAtHead(myList2, 5);
	myList2 = insertAtHead(myList2, 8);
	myList2 = insertAtHead(myList2, 6);
	myList2 = insertAtHead(myList2, 9);
	myList2 = insertAtHead(myList2, 7);
	myList2 = insertAtHead(myList2, 3);
	myList2 = insertAtHead(myList2, 6);
	myList2 = insertAtHead(myList2, 8);
	myList2 = insertAtHead(myList2, 2);

	printf("\nMy List 2 Before REMOVING Duplicates...\n");
	printList(myList2);
	deleteDuplicates(myList2);		// REMOVING Duplicates from a Linked List
	printf("\nMy List 2 After REMOVING Duplicates...\n");
	printList(myList2);
